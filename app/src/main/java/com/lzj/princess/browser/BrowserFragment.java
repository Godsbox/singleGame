 ...
 */
package com.lzj.princess.browser;
...
import com.lzj.princess.AppConstant;
import com.lzj.princess.BaWei;
import com.lzj.princess.R;
import com.lzj.princess.doing.DoingFragment;
...
import static com.lzj.princess.AppConstant.GAME_DIR_PRE;
import static com.lzj.princess.AppConstant.GAME_ID;
import static com.lzj.princess.AppConstant.GAME_UUID;
import static com.lzj.princess.AppConstant.OFFLINE_SHOULDINTER_CHAPTER_URL;
import static com.lzj.princess.AppConstant.OFFLINE_SHOULDINTER_URL;
import static com.lzj.princess.AppConstant.getUserAgent;
                ...
                new AlertDialog.Builder(getContext(), R.style.AlertDialog)
                        ...
                        .setOnDismissListener(new DialogInterface.OnDismissListener() {
                            ...
                            public void onDismiss(DialogInterface dialog) {
                                ImmersionBar.with(getActivity()).hideBar(FLAG_HIDE_NAVIGATION_BAR).init();
                            }
                        })
                        .show();
            }
