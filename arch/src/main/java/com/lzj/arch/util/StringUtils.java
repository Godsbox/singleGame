...
public final class StringUtils {
     ...
     * @return 兆字节字符串
     */
    public static String dealWithLargeNumber(int size) {
        double mb =  size / 10000.00;
        if(mb >= 1){
            return FormatUtils.toTwoDecimal(mb) + "w";
        }
        return size+"";
    }
    ...
    public static boolean isVolume(String url){
        if(url.endsWith(".mp3") || url.endsWith(".dat") ||
                url.endsWith(".wav")){
            return true;
        }
        return false;
